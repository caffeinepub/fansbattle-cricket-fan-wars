...
export class Backend implements backendInterface {
    ...
    async createUser(arg0: string): Promise<{
        joinDate: Time;
        userId: string;
        coins: bigint;
        level: bigint;
    ...
    async findUserByMobileNumber(arg0: string): Promise<Principal> {
        if (this.processError) {
            try {
                const result = await this.actor.findUserByMobileNumber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUser(arg0: Principal): Promise<UserProfile> {
        if (this.processError) {
            try {
    ...
    async getUserCoins(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCoins(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserProfile(arg0: Principal, arg1: string | null, arg2: string | null, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserProfile(arg0, to_candid_opt_n12(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n12(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        favoriteTeam: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.favoriteTeam)),
        level: value.level,
        avatar: value.avatar
    };
}
